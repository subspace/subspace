...
use crate::fraud_proof::{
    InvalidBundlesProofData, InvalidBundlesProofV2, InvalidExtrinsicsRootProofV2,
    InvalidStateTransitionProofV2, ValidBundleProofV2, VerificationError,
};
...
pub fn verify_invalid_state_transition_fraud_proof<CBlock, DomainHeader, Balance>(
    ...
    bad_receipt_parent: ExecutionReceipt<
        ...
        Balance,
    >,
    fraud_proof: &InvalidStateTransitionProofV2,
    domain_runtime_code: Vec<u8>,
) -> Result<(), VerificationError<DomainHeader::Hash>>
where
    CBlock: BlockT,
