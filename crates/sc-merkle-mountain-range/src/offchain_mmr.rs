...
use sp_mmr_primitives::{utils, MmrApi, NodeIndex};
use sp_runtime::traits::{Block, Header, NumberFor, One};
...
//                 .await;
//             let a3 = client
//                 .import_block(&BlockId::Hash(a2.hash()), b"a3", Some(2))
//                 .await;
//             let a4 = client
//                 .import_block(&BlockId::Hash(a3.hash()), b"a4", Some(3))
//                 .await;

//             let b1 = client
//                 .import_block(&BlockId::Number(0), b"b1", Some(0))
//                 .await;
//             let b2 = client
//                 .import_block(&BlockId::Hash(b1.hash()), b"b2", Some(1))
//                 .await;
//             let b3 = client
//                 .import_block(&BlockId::Hash(b2.hash()), b"b3", Some(2))
//                 .await;

//             let c1 = client
//                 .import_block(&BlockId::Number(0), b"c1", Some(0))
//                 .await;

//             let d4 = client
//                 .import_block(&BlockId::Hash(a3.hash()), b"d4", Some(3))
//                 .await;
//             let d5 = client
//                 .import_block(&BlockId::Hash(d4.hash()), b"d5", Some(4))
//                 .await;
...
//                 .await;
//             let a3 = client
//                 .import_block(&BlockId::Hash(a2.hash()), b"a3", Some(0))
//                 .await;
//             let a4 = client
//                 .import_block(&BlockId::Hash(a3.hash()), b"a4", Some(1))
//                 .await;
//             let a5 = client
//                 .import_block(&BlockId::Hash(a4.hash()), b"a5", Some(2))
//                 .await;
...
//                     .await;
//                 let a2 = client
//                     .import_block(&BlockId::Hash(a1.hash()), b"a2", Some(0))
//                     .await;
...
//                 let a2 = blocks[1].clone();
//                 let a3 = client
//                     .import_block(&BlockId::Hash(a2.hash()), b"a3", Some(1))
//                     .await;
//                 let a4 = client
//                     .import_block(&BlockId::Hash(a3.hash()), b"a4", Some(2))
//                     .await;
