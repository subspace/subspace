...
//                     .await;
//                 let a2 = client
//                     .import_block(&BlockId::Number(1), b"a2", Some(1))
//                     .await;
//                 let a3 = client
//                     .import_block(&BlockId::Number(2), b"a3", Some(2))
//                     .await;
...
//             |client| async move {
//                 let a4 = client
//                     .import_block(&BlockId::Number(3), b"a4", Some(3))
//                     .await;
//                 let a5 = client
//                     .import_block(&BlockId::Number(4), b"a5", Some(4))
//                     .await;
//                 let a6 = client
//                     .import_block(&BlockId::Number(5), b"a6", Some(5))
//                     .await;
...
//                 assert_eq!(
//                     load_state::<Block, Backend>(&*client.backend).unwrap(),
//                     Some(6)
//                 );
//             },
//         );
