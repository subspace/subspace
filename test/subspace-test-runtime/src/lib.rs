...
parameter_types! {
    pub const MmrRootHashCount: u32 = 50;
}
...
impl_runtime_apis! {
    ...
    impl subspace_test_primitives::OnchainStateApi<Block, AccountId, Balance> for Runtime {
        ...
        fn verify_proof_and_extract_leaf_data(mmr_leaf_proof: ConsensusChainMmrLeafProof<NumberFor<Block>, <Block as BlockT>::Hash, H256>) -> Option<H256> {
