...
sp_api::decl_runtime_apis! {
        ...
        Balance: Encode + Decode
    {
        ...
        // TODO: move to production runtime since it is also needed for verifying XDM on domain
        /// Verify the mmr proof with `verify_proof_stateless` and extract the leaf data.
        fn verify_proof_and_extract_leaf_data(proof: ConsensusChainMmrLeafProof<NumberFor<Block>, Block::Hash, H256>) -> Option<Block::Hash>;
    }
}
