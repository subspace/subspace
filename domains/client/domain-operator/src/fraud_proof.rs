...
use sp_domains_fraud_proof::fraud_proof::{
    ...
    FraudProofV2, FraudProofVariant, InvalidBlockFeesProofV2, InvalidBundlesProofData,
    InvalidBundlesProofV2, InvalidDomainBlockHashProofV2, InvalidExtrinsicsRootProofV2,
    InvalidStateTransitionProofV2, InvalidTransfersProofV2, ValidBundleDigest, ValidBundleProofV2,
};
    ...
    E: CodeExecutor,
{
    ...
    pub(crate) fn generate_valid_bundle_proof_v2(
        ...
        let valid_bundle_proof = FraudProofV2 {
            ...
            maybe_domain_runtime_code_proof,
            proof: FraudProofVariant::ValidBundle(ValidBundleProofV2 { bundle_with_proof }),
        };
    ...
    pub(crate) fn generate_invalid_block_fees_proof_v2(
        ...
        let invalid_block_fees_proof = FraudProofV2 {
            ...
            maybe_mmr_proof: None,
            maybe_domain_runtime_code_proof,
            proof: FraudProofVariant::InvalidBlockFees(InvalidBlockFeesProofV2 { storage_proof }),
        };
    ...
    pub(crate) fn generate_invalid_transfers_proof_v2(
        ...
        let invalid_transfers_proof = FraudProofV2 {
            ...
            maybe_mmr_proof: None,
            maybe_domain_runtime_code_proof,
            proof: FraudProofVariant::InvalidTransfers(InvalidTransfersProofV2 { storage_proof }),
        };
