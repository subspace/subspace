...
use sp_domains_fraud_proof::fraud_proof::{
    ...
    InvalidBlockFeesProofV2, InvalidDomainBlockHashProofV2, InvalidExtrinsicsRootProofV2,
    InvalidTransfersProofV2,
};
...
async fn test_invalid_domain_extrinsics_root_proof_creation() {
    ...
    let wait_for_fraud_proof_fut = ferdie.wait_for_fraud_proof(move |fp| {
        matches!(
            fp.proof,
            FraudProofVariant::InvalidExtrinsicsRoot(InvalidExtrinsicsRootProofV2 { .. })
        )
    });
